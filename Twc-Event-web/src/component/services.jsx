    ...
    >
      ...
      <div className="flex flex-col lg:flex-row w-full h-full">
        ...
        <motion.div
          ...
          className="bg-orange-500 text-white w-full lg:w-[420px] px-8 py- flex flex-col justify-center rounded-t-lg lg:rounded-l-sm lg:rounded-tr-none shadow-xl z-10 lg:h-[580px]"
        >
