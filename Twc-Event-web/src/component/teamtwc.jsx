        ...
        <div className={`rounded-lg p-6 shadow-xl transform hover:scale-105 transition duration-300 ${staffData[0].bg}`}>
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              <h3 className="text-3xl sm:text-xl font-bold text-neutral-800">{staffData[0].name}</h3>
              <h4 className="text-xl sm:text-lg font-medium text-gray-700">{staffData[0].role}</h4>
              <div className="overflow-y-auto h-40 max-h-96 px-6 sm:px-1 items-center text-center mt-4 sm:text-sm text-lg text-white space-y-8">
              ...
              <div className="flex gap-4 justify-center mt-4">
                ...
                <a href={staffData[0].linkedin} className="text-blue-400 bg-white p-2 rounded-full text-2xl"><FaLinkedinIn /></a>
              </div>
            </div>
          </div>
        </div>
        ...
        {staffData.slice(1, 3).map((staff) => (
          <div key={staff.id} className={`rounded-lg p-6 shadow-md text-center ${staff.bg}`}>
            <img
              src={staff.img}
              alt={staff.name}
              className="w-40 h-52 object-cover rounded-full mx-auto border-4 border-white mb-4"
            />
            <h3 className="text-xl font-bold sm:text-lg" >{staff.name}</h3>
            <h4 className="font-medium text-xl sm:text-base">{staff.role}</h4>  
      ...
      <div className="max-w-3xl mx-auto mb-14">
        <div className={`rounded-lg p-6 shadow-xl transform hover:scale-105 transition duration-300 ${staffData[5].bg}`}>
          <div className="flex flex-col items-center gap-6">
            <img
              src={staffData[5].img}
              alt={staffData[5].name}
              className="w-44 h-64 object-cover rounded-full border-4 border-white mb-4"
            />
            <div className="text-center">
              <h3 className="text-2xl sm:text-xl font-bold text-neutral-800">{staffData[5].name}</h3>
              <h4 className="text-xl sm:text-base font-medium text-gray-700">{staffData[5].role}</h4>
              <div className="overflow-y-auto sm:text-xs h-40 px-4 font-serif font-normal max-h-96 mt-4 text-lg items-center text-center text-neutral-700 space-y-4" >
              ...
              <div className="flex gap-4 justify-center mt-4">
                ...
                <a href={staffData[5].linkedin} className="text-blue-400 bg-white p-2 rounded-full text-xl"><FaLinkedinIn /></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto mb-14 ">
        {staffData.slice(3, 5).map((staff) => (
          <div key={staff.id} className={`rounded-lg p-6 shadow-md text-center ${staff.bg}`}>
            ...
            />
            <h3 className="text-2xl font-bold sm:text-xl">{staff.name}</h3>
            <h4 className="font-medium text-xl sm:text-base">{staff.role}</h4>
            <p className="text-lg mt-2 sm:text-sm">{staff.desc}</p>
            <div className="flex justify-center gap-4 mt-3 text-2xl">
              <a href={staff.facebook} className="text-blue-500 "><FaFacebook /></a>
