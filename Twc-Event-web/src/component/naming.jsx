...
import namingCeremonyImage2 from "../assets/image/IMG_4181.jpg";
...
const NamingCeremony = () => {
  ...
  return (
    <div className="bg-gradient-to-tr from-gray-50 via-gray-100 to-gray-200 px-4 sm:px-10 lg:px-20 py-14">
      <div className="text-center mb-10">
        <h1 className="text-5xl font-extrabold text-gray-800 drop-shadow-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {namingCeremonyPackages.map((pkg) => (
          <div
            key={pkg.id}
            className="bg-white p-6 rounded-2xl shadow-2xl hover:shadow-gray-300 transition-all duration-300 flex flex-col items-center"
          >
            ...
            <h2 className="text-2xl font-bold text-center text-gray-800 mb-2 drop-shadow">{pkg.title}</h2>
