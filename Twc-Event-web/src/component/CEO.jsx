      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center space-y-4 relative">
          <motion.img
            ...
            className="rounded-full shadow-2xl w-72 h-72 md:w-96 md:h-96 object-cover transform transition duration-500 hover:scale-110"
          ...
          <p className="text-lg sm:text-sm text-gray-500">Chief Executive Officer, TWC Event Services</p>
          <button
            onClick={downloadPDF}
        ...
        <div className="w-full md:w-2/3 text-gray-700 space-y-8">
          <motion.img
            src={twc}
            alt="TWC Logo"
            className="absolute top-12 right-12 w-32 md:w-44 opacity-20 transform rotate-12 shadow-lg rounded-xl"
          />
          ...
          <motion.h3 className="text-2xl md:text-3xl font-semibold text-orange-500 mt-8">
            Educational Journey:
          </motion.h3>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <img src={award1} alt="Award 1" className="w-20 h-20 md:w-28 md:h-28 object-contain" />
              <img src={award2} alt="Award 2" className="w-20 h-20 md:w-28 md:h-28 object-contain" />
              <img src={award3} alt="Award 3" className="w-20 h-20 md:w-28 md:h-28 object-contain" />
              <img src={award4} alt="Award 4" className="w-20 h-20 md:w-28 md:h-28 object-contain" />
            </div>
